...
class PlaceCard extends StatelessWidget {
  ...
  const PlaceCard({super.key, required this.place, required this.icon, required this.accent});
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              CircleAvatar(radius: 20, backgroundColor: accent.withValues(alpha: 0.15), child: Icon(icon, color: accent)),
