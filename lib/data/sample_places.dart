...
const sampleAttractions = [
  ...
  LocalPlace(
    ...
    imageAsset: 'assets/places/san_francisco/carrefour.jpg',
  ),
  LocalPlace(
    ...
    imageAsset: 'assets/places/san_francisco/smef_cafe_boulangerie.jpg',
  ),
  LocalPlace(
    name: 'Bill Pressing',
    ...
    imageAsset: 'assets/places/san_francisco/bill_pressing.jpg',
  ),
  LocalPlace(
    name: 'Black and Brown Salon',
    ...
    imageAsset: 'assets/places/san_francisco/black_and_brown_salon.jpg',
  ),
  LocalPlace(
    name: 'Quincaillerie San Francisco',
    category: 'Hardware store',
    rating: 4.1,
    priceTier: '1 500 FCFA',
    sector: 'San Francisco',
    description: 'The go-to hardware store for tools, paint and household fittings in the San Francisco quarter.',
    imageAsset: 'assets/places/san_francisco/quincaillerie.jpg',
  ),
  LocalPlace(
    name: 'Mosquée San Francisco',
    category: 'Neighborhood mosque',
    rating: 4.7,
    priceTier: 'Free',
    sector: 'San Francisco',
    description: 'The neighborhood mosque serving the San Francisco community, open for daily prayers — visitors are welcome to admire the architecture respectfully.',
    imageAsset: 'assets/places/san_francisco/mosquee.jpg',
  ),
