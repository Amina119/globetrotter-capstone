...
JWT verification for the Recommendation Service.

Tokens are issued by the User Service; this service only verifies them
(using the same shared SECRET_KEY), it never issues its own.
"""
import jwt
